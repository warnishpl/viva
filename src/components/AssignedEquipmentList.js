...
import { getLocalStorageValue, setLocalStorageValue } from '../utils/functions/localStorageFunctions';
                    ...
                    <div key={index}>
                        {selectedTutor ? (
                            <>
                                ...
                                <button onClick={() => removeItem(selectedTutor, item.id)}>Usuń z listy</button>
                            </>
                        ) : (
                            <>
                                ...
                                <button onClick={() => removeItem(item.tutorId, item.id)}>Usuń z listy</button>
                            </>
                        )}
                    </div>
                ))
